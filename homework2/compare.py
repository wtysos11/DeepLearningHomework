...
myTree = tree.RandomForestRegressor(n_estimators=10,max_depth = 5)
begin = time.time()
...
skLearnTree = RandomForestRegressor(n_estimators = 10,max_features = 3,max_depth = 5,random_state = 0)
begin = time.time()
